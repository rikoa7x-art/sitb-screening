      ...
      <body className={`${geist.className} bg-gray-50 min-h-screen`}>
        ...
        <header className="bg-blue-700 text-white shadow-md">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-blue-700 font-bold text-lg">🏥</div>
            <div>
              <h1 className="font-bold text-lg leading-tight">Puskesmas Tanjungwangi</h1>
